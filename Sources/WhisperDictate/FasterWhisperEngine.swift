...
struct FasterWhisperEngine: ASREngine {
    ...
    let models: [ASRModel] = [
        ASRModel(
            id: "faster-whisper:tiny", engineId: "faster-whisper",
            label: "Tiny", filename: "models--Systran--faster-whisper-tiny",
            url: "Systran/faster-whisper-tiny",
            size: "75 Mo", storageDir: hfCacheDir,
            downloadType: .huggingFaceRepo, downloadMarker: "refs/main"
        ),
        ASRModel(
            id: "faster-whisper:base", engineId: "faster-whisper",
            label: "Base", filename: "models--Systran--faster-whisper-base",
            url: "Systran/faster-whisper-base",
            size: "145 Mo", storageDir: hfCacheDir,
            downloadType: .huggingFaceRepo, downloadMarker: "refs/main"
        ),
        ASRModel(
            id: "faster-whisper:small", engineId: "faster-whisper",
            label: "Small", filename: "models--Systran--faster-whisper-small",
            url: "Systran/faster-whisper-small",
            size: "484 Mo", storageDir: hfCacheDir,
            downloadType: .huggingFaceRepo, downloadMarker: "refs/main"
        ),
        ASRModel(
            id: "faster-whisper:medium", engineId: "faster-whisper",
            label: "Medium", filename: "models--Systran--faster-whisper-medium",
            url: "Systran/faster-whisper-medium",
            size: "1.5 Go", storageDir: hfCacheDir,
            downloadType: .huggingFaceRepo, downloadMarker: "refs/main"
        ),
        ASRModel(
            id: "faster-whisper:large-v3-turbo", engineId: "faster-whisper",
            label: "Large V3 Turbo", filename: "models--deepdml--faster-whisper-large-v3-turbo-ct2",
            url: "deepdml/faster-whisper-large-v3-turbo-ct2",
            size: "1.6 Go", storageDir: hfCacheDir,
            downloadType: .huggingFaceRepo, downloadMarker: "refs/main"
        ),
        ASRModel(
            id: "faster-whisper:large-v3", engineId: "faster-whisper",
            label: "Large V3", filename: "models--Systran--faster-whisper-large-v3",
            url: "Systran/faster-whisper-large-v3",
            size: "3.1 Go", storageDir: hfCacheDir,
            downloadType: .huggingFaceRepo, downloadMarker: "refs/main"
        ),
        ASRModel(
            id: "faster-whisper:distil-large-v3", engineId: "faster-whisper",
            label: "Distil Large V3", filename: "models--Systran--faster-distil-whisper-large-v3",
    ...
    func transcribe(model: ASRModel, audioURL: URL, language: String) throws -> String {
        ...
        if status != 0 {
            ...
            Log.error("whisper-ctranslate2 failed (status \(status)): \(errorStr)")
