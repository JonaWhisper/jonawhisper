  ...
  <div class="flex flex-col h-full select-none">
    ...
    <div class="flex-1 overflow-y-auto px-5 space-y-4">
      ...
      <div class="space-y-1.5">
        ...
        <div v-if="!showAllModels" class="space-y-1.5">
          <div
            v-for="model in recommendedModels"
            :key="model.id"
            class="flex items-center gap-2.5 px-3 py-2 rounded-lg border border-border bg-card cursor-pointer transition-colors hover:bg-accent/30"
          ...
          >
            ...
            <div class="flex items-center gap-1.5 flex-shrink-0" @click.stop>
              <template v-if="store.downloadingModelId === model.id">
                <Progress :model-value="store.downloadProgress * 100" class="w-20" />
              ...
              <Button v-else size="sm" class="h-7 text-xs" @click="handleDownload(model)">
        ...
        <div v-else class="space-y-3">
          <div v-for="group in allModelsByEngine" :key="group.engine">
    ...
    <!-- Fixed bottom -->
    <div class="px-5 pt-3 pb-4 border-t border-border">
